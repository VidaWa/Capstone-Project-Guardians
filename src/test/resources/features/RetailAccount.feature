...
Feature: Retail Account Page
  ...
  Scenario: Verify User can update Profile Information
    And User update Name 'GuardianV' and Phone '2021234561'
  ...
  Scenario: Verify User can add a payment method
    ...
    And User fill Debit or credit card information
      ...
      | 1111222233334444 | Guardians  |              10 |           2027 |          123 |
  ...
  Scenario: Verify User can edit Debit or Credit card
    ...
    And user edit information with below data
      | cardNumber       | nameOnCard | expirationMonth | expirationYear | securityCode |
      | 1111222233339999 | Guard     |              11 |           2026 |          333 |
  ...
  Scenario: Verify User can add an Address
    ...
    And user fill new address form with below information
      ...
      | United States | Karim  |  2024567893 | 8939 Ozzie Run | Suite 192 | West Bill | Utah  |   73463 |
  ...
  Scenario: Verify User can edit an Address added on account
    ...
    And user fill the new address form with below information
      | country       | fullName | phoneNumber | streetAddress | apt       | city      | state | zipCode |
      | United States | Muslim    |  2024567891 | 8939 Box Run  | Suite 192 | West Bill | Utah  |   73463 |
