...
public class CommonUtility extends BaseSetup{
	// why extend BaseSetup? To be able to access the instance of WebDriver from 
		// getDriver method in the BsseSetup class 
		    ...
		    // by me
//		    public List<WebElement> waitTillPresence(List<WebElement> element) {
//		        return this.getWait().until(ExpectedConditions.visibilityOfAllElements(element));
//		    }
		    ...
		    //by me
//		    public String getElementsText(List<WebElement> element) {
//		        return this.waitTillPresence(element).getText());
//		    }
